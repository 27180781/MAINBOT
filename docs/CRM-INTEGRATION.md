...
אותו מנוע שעונה בטלפון זמין גם כצ'אט טקסט: אותם כלי MCP, אותם כללים קבועים, אותו מנגנון אישור לפני פעולות. ההבדל היחיד הוא הפרומפט: בצ'אט מותר עיצוב קל (רשימות, הדגשות), ואין `end_call`.
